...
class ball_tracking:
    ...
    def __init__(self):
        ...
        camera_name = rospy.get_param("~camera_name", "usb_cam")
        rospy.loginfo(camera_name)
        self.image_sub = rospy.Subscriber(camera_name + '/image_raw', Image, self.image_callback)
